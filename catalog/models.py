...
class Genre(models.Model):
	#Model represents a book's genre(e.g Sci-Fi, Non fiction)

    name = models.CharField(max_length=200, help_text='Enter a book genre')

    def __str__(self):
    	#String that represents the Model obj (in admin site etc)
...
class Book(models.Model):
	...
	def get_absolute_url(self):
		#returns url to access record of book
...
class BookInstance(models.Model):
	#Model represents a specific book 
